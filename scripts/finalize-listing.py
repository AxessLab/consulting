...
from assignment_platforms import AssignmentRecord, assignment_from_dict
...
def assignment_index(candidates: dict[str, Any]) -> dict[str, AssignmentRecord]:
    ...
    for row in candidates.get("assignments", []):
        record = assignment_from_dict(row)
    ...
    *,
    ...
    lines = [
        ...
        (
            ...
            f"(unique by source: {stats.get('total_unique_visible', 0)}, "
            "after cross-source dedupe: "
