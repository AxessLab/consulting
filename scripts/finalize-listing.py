...
def build_slack_debug(
    *,
    ...
    lines = [
        ...
        f"Total visible per source: {fmt_counts(visible_by_source)}",
        f"Total unique visible per source: {fmt_counts(unique_by_source)}",
        f"New ids per source: {fmt_counts(new_by_source)}",
