...
def prepare_candidates(
    *,
    ...
    seen_ids_by_source, previous_memory = load_seen_by_source(memory_path)
    ...
    seen_keys = {
        ...
        for source_key, source_ids in seen_ids_by_source.items()
    ...
    reporting_assignments = cross_platform_dedupe(new_assignments)
    all_visible_assignments = cross_platform_dedupe(raw_assignments)
    ...
    return {
        ...
        "stats": {
            ...
            "total_unique_visible": len(all_visible_assignments),
            ...
            "new_ids_by_source": {
                source_key: sum(
                    ...
                    and assignment.dedupe_key not in seen_keys
                )
        ...
        "assignments": [record.to_dict() for record in reporting_assignments],
        "visible_assignments": [record.to_dict() for record in raw_assignments],
        "new_dedupe_keys": [assignment.dedupe_key for assignment in reporting_assignments],
