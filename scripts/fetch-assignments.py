...
def prepare_candidates(
    *,
    ...
    for result in platform_results:
        ...
        unique_visible_by_source[result.platform] = len(source_ids)
        seen_source_ids = seen_ids_by_source.get(result.platform, set())
        new_ids_by_source[result.platform] = len(source_ids - seen_source_ids)
