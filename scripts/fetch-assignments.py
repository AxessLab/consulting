...
def prepare_candidates(
    *,
    ...
    seen_by_source, memory_data = load_memory(memory_path)
    ...
    return {
        ...
        "stats": {
            ...
            "total_unique_after_cross_source_dedupe": len(report_pool),
        ...
        "report_pool_listing_ids": [record.listing_id for record in report_pool],
