...
def prepare_candidates(
    *,
    ...
    new_assignments = [
        ...
        if source_is_new(memory, assignment)
    ]
    all_new_by_source: dict[str, list[str]] = {}
    for assignment in raw_assignments:
        if source_is_new(memory, assignment):
            all_new_by_source.setdefault(assignment.source_key, []).append(assignment.source_id)
    all_new_by_source = {
        source_key: sorted(set(ids)) for source_key, ids in all_new_by_source.items()
    }
    ...
    return {
        ...
        "stats": {
            ...
            "new_ids_by_source": all_new_by_source,
        ...
        "new_source_ids_by_source": all_new_by_source,
