...
from listing_memory import collect_seen_ids_by_source
...
def build_slack_debug(
    *,
    ...
    lines = [
        ...
        f"Visible assignments: {total_visible} (reporting pool after cross-source dedupe: {total_unique_visible})",
        f"New ids: {new_count}",
...
def prepare_listing(
    *,
    ...
    new_assignments = [
        ...
        not in seen_ids_by_source.get(assignment.resolved_source_key, set())
    ]
        ...
        "matches": [
            {
                ...
                "source_key": match.assignment.resolved_source_key,
                "platform": match.assignment.resolved_source_key,
