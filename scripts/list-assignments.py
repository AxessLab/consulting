...
from listing_memory import DEFAULT_MEMORY_PATH, build_memory_payload, commit_memory, load_seen_by_source
...
def prepare_listing(
    *,
    ...
    new_pool = [
        assignment for assignment in raw_assignments if assignment.dedupe_key not in seen_keys
    ]
    deduped_assignments = cross_platform_dedupe(new_pool)
    new_assignments = [
