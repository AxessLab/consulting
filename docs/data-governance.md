...
- be DOCX files generated from a selected source CV, Cinode profile data,
  curated CV summary, and assignment ad
...
selected language, selected CV variant, source CV, short positioning summary, and
a review reminder. Do not paste full raw CV content into Slack.
