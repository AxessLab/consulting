...
3. If the first remaining token is a listed assignment id, use **listed
   assignment mode**. Listed ids use the source prefix plus native id:
   allakonsultuppdrag (`a6236`), Verama (`v81387`), Chas Partner Network
   (`c19622`), Magnit Source (`mcbbe63d1-d81a-bff3-1f3f-95e1a814e812`), or
   Cinode Market (`n22191`). The assignment id is that token; the consultant
