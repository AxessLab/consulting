...
- `assignments` — currently visible canonical records after cross-source report dedupe (for lookup)
...
`total_unique_visible`. Newness is checked per source against these bare ids;
Slack ids use prefixes (`a6236`, `v81387`).
