...
- `new_dedupe_keys` — source ids not seen for that source before
...
- `platform_summary` — scanned source counts for the debug thread
...
single-letter `prefix`, bare `seen_ids`, `total_visible`, and
