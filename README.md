...
or `n` followed by that source's native id), the automation reads the Slack
parent message, finds the assignment id, resolves the assignment ad link, and
fetches the online ad page.
...
`m`, or `n` followed by that source's native id), the automation reads the
Slack parent message, finds the assignment id, resolves the assignment ad link,
and fetches the online ad page.
